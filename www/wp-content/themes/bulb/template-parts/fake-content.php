...
<div class="fake" data-scroll-section>
    ...
    <div class="fake__box">
        <p data-scroll>check if in view</p>
        <p data-scroll>check if in view</p>
        <p data-scroll>check if in view</p>
    </div>
</div>
...
<div class="fake" data-scroll-section>
    <div class="fake__box fake__box--right" data-scroll>
    ...
    <div class="fake__box">fake box</div>
    <div class="fake__box fake__box--right">fake box</div>
</div>
